...
<div class="pipeline-toolbar">
	...
	<div class="toolbar-center">
		<button class="toolbar-btn" onclick={onUndo} disabled={!canUndo}>
			<svg width="16" height="16" viewBox="0 0 16 16" fill="none">
				<path d="M3 6h7a3 3 0 110 6H7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
				<path d="M6 3L3 6l3 3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
			</svg>
			<span>Undo</span>
		</button>
		<button class="toolbar-btn" onclick={onRedo} disabled={!canRedo}>
			<svg width="16" height="16" viewBox="0 0 16 16" fill="none">
				<path d="M13 6H6a3 3 0 100 6h3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
				<path d="M10 3l3 3-3 3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
			</svg>
			<span>Redo</span>
		</button>
	</div>
